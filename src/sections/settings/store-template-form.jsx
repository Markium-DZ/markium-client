...
const TEMPLATES = [
  {
    ...
    image: '/assets/templates/clothing.webp',
    preview: '/assets/templates/clothing.webp',
  },
  {
    id: 'shoes',
    title: 'Shoes',
    description: 'Traditional and elegant layout with timeless appeal',
    image: '/assets/templates/shoes.webp',
    preview: '/assets/templates/shoes.webp',
  },
  {
    id: 'furniture',
    title: 'Furniture',
    description: 'Simple and focused design with plenty of white space',
    image: '/assets/templates/furniture.webp',
    preview: '/assets/templates/furniture.webp',
  },
  {
    id: 'kitchen',
    title: 'Kitchen',
    description: 'Bold colors and dynamic layouts for eye-catching stores',
    image: '/assets/templates/kitchen.webp',
    preview: '/assets/templates/kitchen.webp',
  },
  {
    id: 'jewellery',
    title: 'Jewellery',
    description: 'Professional and trustworthy design for business stores',
    image: '/assets/templates/jewellery.webp',
    preview: '/assets/templates/jewellery.webp',
  },
  {
    id: 'autoparts',
    title: 'Autoparts',
    description: 'Stylish and sophisticated design for fashion stores',
    image: '/assets/templates/autoparts.webp',
    preview: '/assets/templates/autoparts.webp',
  },
  {
    id: 'islamic-lib',
    title: 'Islamic Library',
    description: 'Elegant design for Islamic books and religious content stores',
    image: '/assets/templates/islamic-lib.webp',
    preview: '/assets/templates/islamic-lib.webp',
  },
  {
    id: 'islamic-lib2',
    title: 'Islamic Library 2',
    description: 'Elegant design for Islamic books and religious content stores',
    image: '/assets/templates/islamic-lib2.webp',
    preview: '/assets/templates/islamic-lib2.webp',
  },
  {
    id: 'spices',
    title: 'Spices & Herbs',
    description: 'Traditional and aromatic design for spices and herbs stores',
    image: '/assets/templates/spices.webp',
    preview: '/assets/templates/spices.webp',
  },
  {
    id: 'bags',
    title: 'Bags',
    description: 'Modern and elegant design perfect for bags and accessories stores',
    image: '/assets/templates/bags.webp',
    preview: '/assets/templates/bags.webp',
  },
  {
    id: 'hardware-store',
    title: 'Hardware Store',
    description: 'Professional and robust design perfect for hardware and tools stores',
    image: '/assets/templates/hardware-store.webp',
    preview: '/assets/templates/hardware-store.webp',
  },
  {
    id: 'electronics',
    title: 'Electronics',
    description: 'Modern and tech-focused design perfect for electronics and gadget stores',
    image: '/assets/templates/electronics.webp',
    preview: '/assets/templates/electronics.webp',
  },
  {
    id: 'health-cosmetics',
    title: 'Health & Cosmetics',
    description: 'Clean and elegant design perfect for health and beauty stores',
    image: '/assets/templates/health.webp',
    preview: '/assets/templates/health.webp',
  },
  {
    id: 'women-fashion',
    title: 'Women Fashion',
    description: 'Elegant and stylish design perfect for women\'s fashion and apparel stores',
    image: '/assets/templates/women-fashion.webp',
    preview: '/assets/templates/women-fashion.webp',
  },
  {
    id: 'default',
    title: 'Default',
    description: 'Stylish and sophisticated design for fashion stores',
    image: '/assets/templates/default.webp',
    preview: '/assets/templates/default.webp',
  },
];
